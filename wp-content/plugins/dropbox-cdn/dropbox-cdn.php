...
<?php wp_nonce_field('dbcdn-pu-options'); ?>
...
<div style="text-align: center"><img src="<?php bloginfo('url') ?>/wp-content/plugins/dropbox-cdn/images/dropdown.png" /></div>
...
<div style="text-align: center"><img src="<?php bloginfo('url') ?>/wp-content/plugins/dropbox-cdn/images/copyurl.png" /></div>
<tr valign="top">
<th scope="row">URL to public folder<br /><span style="font-size: x-small;">The URL to your Dropbox Public folder</span></th>
<td>
<input type="text" name="dbcdn_url" value="<?php if (get_option('dbcdn_url')) { echo get_option('dbcdn_url'); } ?>" size="50" />
</td>
</tr>
...
<select name="dbcdn_enabled">
	<option <?php if (!get_option('dbcdn_enabled') || get_option('dbcdn_enabled') == '1') {?>SELECTED<?php;}?> value="1">Yes</option>
	<option <?php if (get_option('dbcdn_enabled') == '0') {?>SELECTED<?php;}?> value="0">No</option>
</select>
</td>
</tr>
</ul>
...
<?php settings_fields( 'dbcdn-pu-options' ); ?>
</form>
