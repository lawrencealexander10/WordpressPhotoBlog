...
// document.createElement('testlog');
/*!
 * jQuery Lazy - v0.1.15
...
$('noscript').each(function(){
  ...
  if($tgt.attr('data-lazy')=='true') {
    ...
    $img.attr('data-src',$tgt.attr('data-src')).addClass('lazy');
  } else {
  ...
  $img.lazy({
        ...
        afterLoad:function(img){
          $('div').html($('div').html()+'<br>' + img[0].src);
          img.removeClass('lazy').removeAttr('style').removeAttr('data-ratio');
        }
    });
